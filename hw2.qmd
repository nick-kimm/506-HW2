...
#Part c:
```{r}
hist(cars_r$Highway_mpg,freq=TRUE,title="Frequency plot of Highway MPG")
hist(cars_r$Highway_mpg[cars_r$Highway_mpg<100],breaks=10,freq=TRUE,title="Frequency plot of Highway MPG excluding Outlier")
hist(log(cars_r$Highway_mpg[cars_r$Highway_mpg<100]),breaks=10,freq=TRUE,title="Frequency plot of Highway MPG with Log Transform")
```
